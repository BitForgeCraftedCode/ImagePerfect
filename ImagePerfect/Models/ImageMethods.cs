...
namespace ImagePerfect.Models
{
    public class ImageMethods
    {
        ...
        {
            return await _unitOfWork.Image.GetAllImagesInFolderAndSubFolders(folderPath);
        }
        ...
        {
            return await _unitOfWork.Image.GetAllImagesWithTags(tagNames, filterInCurrentDirectory, currentDirectory);
        }
